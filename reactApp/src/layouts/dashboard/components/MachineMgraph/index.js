...
import { MachineMDaily } from "./machine_M_daily";
import { MachineMHour } from "./machine_M_hour";

export const MachineMgraph = () => {
  ...
  return (
    <Card style={{ marginLeft: 'auto', marginRight: 'auto' }}>
      <MDBox color="text" style={{ position: 'relative', flex: 1 }}>
        ...
        />
        {renderMenu}
        {isMTDVisible ? <MDBox ><MachineMDaily /></MDBox> : null}
        {isMTHVisible ? <MDBox ><MachineMHour /></MDBox> : null}
      </MDBox>
    </Card>
  );
}

export default MachineMgraph;
