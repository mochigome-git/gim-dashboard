    ...
    try {
        ...
        for (const currentTableName of tableNames) {
            ...
            try {
              ...
              if (error) {
                throw new Error(`Error fetching data for ${currentTableName} using date_time: ${error.message}`);
              }
            } catch (dateError) {
              ...
              try {
                ...
                if (error) {
                  throw new Error(`Error fetching data for ${currentTableName} using created_at: ${error.message}`);
                }
