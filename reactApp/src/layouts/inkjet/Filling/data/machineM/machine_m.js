...
export const Machine_MData = () => {
  ...
  return {
    columns: [
      ...
      { Header: "ch1 filing DO", accessor: "ch1_do", width: "1%", align: "left" },
      { Header: "ch2 filing DO", accessor: "ch2_do", width: "1%", align: "left" },
      { Header: "ch3 filing DO", accessor: "ch3_do", width: "1%", align: "left" },
      { Header: "quantity", 
      accessor: ({counter}) =>{
