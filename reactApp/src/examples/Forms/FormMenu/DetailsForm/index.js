...
export default function DetailsForm({ 
  ...
  useEffect(() => {
    const description = state?.description_textfield;
    const section = state?.section_textfield;
    const machine = state?.machine_textfield;
    const quantity = state?.quantity_textfield;
    const unit = state?.unit_textfield;
    const price = state?.price_textfield;
